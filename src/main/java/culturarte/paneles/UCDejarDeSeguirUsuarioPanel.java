...
/*
 ...
 1) Abrir este archivo: UCDejarDeSeguirUsuarioPanel.java
2) En el constructor (UCDejarDeSeguirUsuarioPanel), modificar la dimensión en setPreferredSize:
 ...
 * @author tecnologo
 */
public class UCDejarDeSeguirUsuarioPanel extends javax.swing.JPanel {

    /**
     * Creates new form UCDejarDeSeguirUsuarioPanel
     */
    public UCDejarDeSeguirUsuarioPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCargar.setPreferredSize(new java.awt.Dimension(195, 24));
        ...
        btnDejar.setText("Dejar de seguir");
    ...
    try {
        if (comboSeguidor.getSelectedItem() == null || comboSeguido.getSelectedItem() == null) return;
        ...
        try {
            ...
            javax.persistence.TypedQuery<culturarte.casosuso.Follow> q = em.createQuery(
                "SELECT f FROM Follow f WHERE f.seguidor.id = :s AND f.seguido.id = :t",
                culturarte.casosuso.Follow.class);
            q.setParameter("s", seguidorId);
            q.setParameter("t", seguidoId);
            java.util.List<culturarte.casosuso.Follow> list = q.getResultList();
            int removed = 0;
            for (culturarte.casosuso.Follow f : list) {
                em.remove(em.contains(f) ? f : em.merge(f));
                removed++;
            }
            em.getTransaction().commit();
            if (removed > 0) javax.swing.JOptionPane.showMessageDialog(this, "Dejó de seguir");
            else javax.swing.JOptionPane.showMessageDialog(this, "No existía la relación");
    ...
    try {
            ...
            try {
                ...
                for (culturarte.casosuso.Usuario u: users) {
                    String item = u.getId() + ":" + u.getNickname();
